...
const TrustBar = () => {
  return (
    <section className="relative py-16 lg:py-20 bg-card overflow-hidden">
      {/* Gradient background */}
      <div className="absolute inset-0 bg-gradient-to-r from-[#242d54]/5 via-transparent to-[#e2d37d]/10" />
          ...
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-[#e2d37d]/20 to-[#e2d37d]/30 mb-5 group-hover:from-[#e2d37d]/30 group-hover:to-[#e2d37d]/40 transition-all duration-300 group-hover:scale-110 shadow-soft">
                <stat.icon className="w-7 h-7 text-[#242d54] group-hover:text-[#1a2140] transition-colors duration-300" />
              </div>
              
              {/* Number with gradient */}
              <div className="text-4xl lg:text-5xl font-bold text-[#242d54] mb-2 tracking-tight">
                {stat.number}
              </div>
