    ...
    <section id="blog" className="py-20 bg-white">
      <div className="container mx-auto px-4">
          ...
          {blogPosts.map((post, index) => (
            ...
            >
              ...
              <div className="relative overflow-hidden aspect-[3/2]">
                ...
                />
                <span className="absolute top-4 left-4 px-3 py-1 bg-white/90 backdrop-blur-sm rounded-full text-xs font-medium text-[#20244A]">
                  {post.category}
                </span>
              </div>
              ...
              <div className="p-6">
                ...
                <h3 className="font-bold text-lg text-foreground mb-2 line-clamp-2 group-hover:text-[#20244A] transition-colors">
                  {post.title}
                </h3>
                <p className="text-muted-foreground text-sm mb-4 line-clamp-2">
                  {post.excerpt}
                </p>
                <button className="text-[#20244A] font-medium text-sm inline-flex items-center gap-1 group/btn">
                  Ler mais
        ...
        <div className="text-center mt-12">
          <Button variant="outline" size="lg" className="border-[#20244A] text-[#20244A] hover:bg-[#20244A] hover:text-white">
