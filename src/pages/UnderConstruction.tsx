  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-amber-100 flex flex-col items-center justify-center p-6">
      ...
      <div className="text-center mb-8">
        <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 tracking-tight" style={{ fontFamily: "'Poppins', sans-serif" }}>
          TRILHOS
        </h1>
        <p className="text-sm text-slate-600 tracking-[0.3em] uppercase mt-1" style={{ fontFamily: "'Poppins', sans-serif" }}>
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-xl max-w-md w-full text-center">
        <h2 className="text-2xl md:text-3xl font-bold text-slate-800 mb-4" style={{ fontFamily: "'Poppins', sans-serif" }}>
          Site em Construção
        </h2>
        ...
        {!showLogin ? (
          <Button 
            ...
            className="bg-slate-900 hover:bg-slate-800 text-white px-6 py-3 rounded-full"
          >
